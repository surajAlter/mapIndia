  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/rail-network" element={<IndiaRailwayNetworkMap />} />
        ...
        <Route path="/driving-direction-maps" element={<ComingSoon />} />
        ...
        <Route path="/states/uttar-pradesh" element={<UttarPradesh />} />
        <Route path="/states/uttarakhand" element={<Uttarakhand />} />
        <Route path="/states/west-bengal" element={<WestBengal />} />
        <Route path="/states/jammu-kashmir" element={<JammuKashmir />} />
        <Route path="/states/ladakh" element={<Ladakh />} />
        <Route path="/states/andaman-and-nicobar" element={<AndamanAndNicobar />} />
        ...
        <Route path="/maps/railway" element={<IndiaRailwayNetworkMap />} />
        <Route path="/maps/road" element={<IndiaRoadNetworkMap />} />
        <Route path="/maps/river" element={<IndiaRiverSystemMap />} />
        <Route path="/maps/climate" element={<IndiaClimaticRegionsMap />} />
        <Route path="/maps/topographic" element={<IndiaTopographicMap />} />
        ...
        <Route path="/maps/per-capita-income" element={<ComingSoon />} />
        ...
        <Route path="/maps/national-highways" element={<ComingSoon />} />
        <Route path="/maps/railway-map" element={<ComingSoon />} />
        <Route path="/maps/railway-timetable" element={<ComingSoon />} />
        ...
        <Route path="/maps/india-independence-2019" element={<ComingSoon />} />
        ...
        <Route path="/maps/why-india-matters" element={<ComingSoon />} />
