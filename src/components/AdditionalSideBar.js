  ...
  const sections = [
    {
      ...
      links: [
        ...
        { label: "States and Capitals of India", path: "/maps/states-capitals" },
        ...
        { label: "Tier I And Tier II Cities of India", path: "/maps/tier-cities" },
        { label: "Current CM and Governors of India", path: "/maps/cm-governors" },
        { label: "Per Capita Income of India", path: "/maps/per-capita-income" },
        { label: "Climate Map of India", path: "/maps/climate" },
        { label: "Temperature Map of India", path: "/maps/temperature" },
        { label: "India Seismic Zone Map", path: "/maps/seismic-zones" },
        { label: "India Topographic Map", path: "/maps/topographic" },
        { label: "Mountain Ranges in India", path: "/maps/mountain-ranges" },
        ...
        { label: "Thermal Power Plants in India", path: "/maps/thermal" },
        { label: "Nuclear Power Plants in India", path: "/maps/nuclear" },
        { label: "Pre Partition Map of India", path: "/maps/pre-partition" },
        { label: "Annual Rainfall in India", path: "/maps/rainfall" },
        { label: "Water Resources of India", path: "/maps/water-resources" },
        { label: "Map of Ruling Parties of India", path: "/maps/ruling-parties" },
        { label: "India Map in Various Languages", path: "/maps/languages" },
    ...
    },
    {
      ...
      links: [
        ...
        { label: "National Highways in India", path: "/maps/national-highways" },
        { label: "India Railway Map", path: "/maps/railway-map" },
        { label: "Indian Railways Timetable", path: "/maps/railway-timetable" },
        { label: "Railway Zones Map of India", path: "/maps/railway-zones" },
    ...
    },
    {
      ...
      links: [
        ...
        { label: "Independence Day Wallpapers", path: "/maps/independence-day" },
        { label: "India Independence Day 2019", path: "/maps/india-independence-2019" },
        ...
        { label: "Chief Ministers of India", path: "/maps/chief-ministers" },
      ],
    },
    {
      title: "Travel to India",
      links: [
        { label: "Tourist Places in India", path: "/maps/tourist-places" },
        { label: "Religious Places in India", path: "/maps/religious-places" },
        ...
        { label: "Hill Stations in India", path: "/maps/hill-stations" },
        { label: "Hotels in India", path: "/maps/hotels" },
        { label: "Jyotirlinga Shrines in India", path: "/maps/jyotirlinga" },
      ],
    },
    {
  ...
  return (
    <>
      ...
      <div className="md:hidden flex justify-between items-center p-4 bg-white shadow">
        <h2 className="text-lg font-bold text-blue-700">Additional Maps</h2>
        <button onClick={toggleSidebar} className="text-blue-700 hover:text-blue-900">
      ...
      >
        <h2 className="text-xl font-bold text-blue-700 mb-4 hidden md:block">Additional Maps</h2>
