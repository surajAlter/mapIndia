    ...
    <div className="flex flex-col md:flex-row min-h-screen bg-gray-50">
      ...
      <main className="w-full md:w-3/4 p-6 md:p-10 max-w-6xl mx-auto text-gray-800">
        ...
        <header className="mb-6">
          <h1 className="text-4xl font-extrabold text-gray-800">India Railway Network Map</h1>
          <h2 className="text-xl text-blue-700 mt-1">भारतीय रेलवे मानचित्र</h2>
        </header>
        ...
        <section className="space-y-6 bg-white p-6 rounded-xl shadow-sm text-base leading-relaxed">
          <p>Indian Railways Map shows the network across the country with different zones like Central Railway, Eastern Railway, Northern Railway, and more.</p>
          <p>It is the backbone of freight and passenger transportation in India, vital to industrial and agricultural growth.</p>
          <p>Operating over 9,000 passenger trains daily, it moves about 18 million passengers and employs over 1.4 million people—one of the world’s largest networks.</p>
          <p>The first freight train ran in 1851 and the first passenger train in 1853 between Bombay and Thane, marking the beginning of Indian Railways.</p>
          <p>The network weaves together India’s diverse regions—socially, culturally, and economically.</p>
          <p>Recent projects like the Harmuti–Naharlagun line have brought connectivity to remote states like Arunachal Pradesh.</p>
          <p>Indian Railways has 18 zones, including NR, WR, SR, CR, and more, each managing operations across major regions.</p>
        </section>
