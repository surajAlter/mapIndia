...
const districtInfo = {
  Hyderabad: "The bustling capital, renowned for its iconic Charminar, Golconda Fort, and a flourishing IT industry.",
  Karimnagar: "A district with rich historical roots and agricultural prominence, featuring ancient temples.",
  Warangal: "Home to magnificent Kakatiya-era monuments, including Warangal Fort and the Thousand Pillar Temple.",
  Nizamabad: "Known for its historic sites, scenic lakes, and a blend of cultural traditions.",
  Khammam: "A district celebrated for its cultural heritage, natural landscapes, and historical forts.",
  Nalgonda: "Characterized by ancient temples and rural charm.",
  Medak: "Rich in history, known for its impressive Medak Cathedral.",
  Rangareddy: "An emerging industrial and suburban hub adjacent to Hyderabad.",
};
  ...
  return (
    <div className="flex flex-col md:flex-row px-4 sm:px-10 md:px-20 py-10 text-[#333] gap-10">
      ...
      <div className="md:w-2/4 w-full space-y-10">
        ...
        {/* State Info Section */}
        <section>
          <h1 className="text-4xl font-bold text-[#2E3A59] mb-4">Telangana</h1>
          <p className="text-lg leading-7">
            Formed in 2014, Telangana is a land of historical marvels and dynamic growth, blending rich cultural heritage with rapid modernization.
          </p>
        </section>
