		...
		<div className="flex flex-col md:flex-row min-h-screen bg-[#f9fafb] text-[#333]">
			...
			<main className="flex-1 px-6 py-10 space-y-10">
				...
				<section className="max-w-4xl mx-auto space-y-6">
					<h1 className="text-4xl font-bold text-[#2E3A59]">Tripura</h1>
					<p className="text-lg leading-7">
						Tripura, nestled in the Northeast, combines rich tribal
						traditions with natural beauty and historical landmarks.
						Its scenic landscapes and cultural diversity make it a unique destination.
					</p>

					{/* Quick Facts */}
					<div className="mt-6">
						<h2 className="text-2xl font-semibold text-[#2E3A59] mb-3">Quick Facts</h2>
						<ul className="list-disc list-inside space-y-1">
							<li><strong>Capital:</strong> Agartala</li>
							<li><strong>Area:</strong> 10,491 sq km</li>
							<li><strong>Population:</strong> ~3.67 million</li>
							<li><strong>Official Language:</strong> Bengali, Kokborok</li>
						</ul>
					</div>
					...
					{/* Geography & Climate */}
					<div className="mt-6">
						<h2 className="text-2xl font-semibold text-[#2E3A59] mb-3">Geography & Climate</h2>
						<p className="text-lg leading-7">
							Tripura features a tropical savanna climate with distinct wet and dry seasons,
							complemented by rolling hills and dense forests.
						</p>
					</div>

					{/* Transport */}
					<div className="mt-6">
						<h2 className="text-2xl font-semibold text-[#2E3A59] mb-3">Transport</h2>
					...
					{/* Government */}
					<div className="mt-6">
						<h2 className="text-2xl font-semibold text-[#2E3A59] mb-3">Government</h2>
						<ul className="list-disc list-inside">
							<li>Unicameral Legislature</li>
							<li>Divided into 8 districts (current status may vary)</li>
						</ul>
					</div>
				</section>
