	...
	return (
		<div className="flex flex-col md:flex-row min-h-screen bg-[#f9fafb] text-[#333]">
			...
			<div className="md:hidden bg-white p-4 flex justify-between items-center shadow-md sticky top-0 z-20">
				<h1 className="text-xl font-bold text-amber-600">Uttar Pradesh</h1>
			...
			<main className="flex-1 px-6 py-10 space-y-10">
				...
				<section className="max-w-4xl mx-auto space-y-6">
					<h1 className="text-4xl font-bold text-[#2E3A59]">Uttar Pradesh</h1>
					<p className="text-lg leading-7">
						Uttar Pradesh, located in northern India, is steeped in ancient
						history and spirituality. The state is home to iconic monuments,
						bustling cities, and revered pilgrimage sites.
					</p>
				</section>
