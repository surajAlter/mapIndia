          ...
          {districts.map((district) => (
            <li
              ...
              className={`cursor-pointer px-3 py-2 rounded-lg hover:bg-blue-100 ${
                selectedDistrict === district ? 'bg-blue-200 font-semibold' : ''
              }`}
      ...
      <main className="w-3/4">
        ...
        <section className="space-y-6">
          <div>
            ...
            <p>
              Ladakh was formed from the state of Jammu and Kashmir on October 31, 2019, following the abrogation of Article 370. It comprises two districts — <strong>Leh</strong> and <strong>Kargil</strong> — and is administered as a Union Territory directly by the central government.
            </p>
            <p>
              Ladakh has its own police force and receives direct funding from the Centre. It comes under the jurisdiction of the Jammu & Kashmir High Court and follows central civil service rules. The first Lieutenant Governor of Ladakh was Radha Krishna Mathur.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              Ladakh has around 1,800 km of roads, of which 800 km are surfaced. The <strong>Kushok Bakula Rimpochee Airport</strong> in Leh connects Ladakh to Delhi and other major cities. Kargil also has a functioning airport.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside">
              ...
              <li>Union Territory governed by: Ministry of Home Affairs</li>
              ...
              <li>Famous for: Buddhist monasteries, mountains, lakes like Pangong Tso & Tso Moriri</li>
            </ul>
          </div>
        </section>
      </main>
