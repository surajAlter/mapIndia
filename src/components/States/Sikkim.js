	...
	return (
		<div className="flex flex-col md:flex-row min-h-screen bg-[#f9fafb] text-[#333]">
			...
			<div className="md:w-3/4 w-full px-6 py-10 space-y-10">
				...
				{/* Sikkim Overview */}
				<section>
					<h1 className="text-4xl font-bold text-[#2E3A59] mb-4">Sikkim</h1>
					<p className="text-lg leading-7">
						Nestled in the Himalayas, Sikkim is known for its breathtaking
						mountain landscapes, vibrant Buddhist culture, and pristine natural
						beauty. This small state offers a unique blend of adventure and
						serenity.
					</p>
				</section>
